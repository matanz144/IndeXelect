...
function exportFromJSON({ data, fileName = 'download', exportType = 'txt', replacer = null, space = 4, processor = downloadFile, withBOM = false, }) {
    ...
    switch (exportType) {
        ...
        case 'csv': {
            ...
            const BOM = '\ufeff';
            const CSVData = createCSVData(safeData);
